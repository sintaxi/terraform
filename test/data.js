...
describe("yaml", function(){
  ...
  describe("valid", function(){
    var root = __dirname + "/fixtures/yaml/valid"
    var poly = polymer.root(root)
  ...
  describe("invalid", function(){
    it("should return errors when invalid _data.yaml file", function(done){
      var root = __dirname + "/fixtures/yaml/invalid"
      try{
        var poly = polymer.root(root)
      }catch(error){
        should.exist(error)
  ...
  describe("missing", function(){
    it("should return errors when missing source directory", function(done){
      var root = __dirname + "/fixtures/yaml/nonexisting"
      try{
        var poly = polymer.root(root)
      }catch(error){
        should.exist(error)
  ...
  describe("public", function(){
    it("should return public object", function(done){
      var root = __dirname + "/fixtures/yaml/valid"
      var poly = polymer.root(root)
      poly.render("pub.yaml.jade", { "layout": false }, function(err, result){
        var pub = JSON.parse(result)
        should.not.exist(pub[".foo"])
        done()
      })
