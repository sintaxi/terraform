  ...
  describe("invalid", function(){
    it("should return errors when invalid _data.json file", function(done){
      ...
      try{
        ...
        should.exist(error)
        error.should.have.property('source', "JSON Data")
...
describe("data-cson", function(){

  describe("valid", function(){
    var root = __dirname + "/fixtures/data-cson/valid"
    var poly = polymer.root(root)
  ...
  describe("invalid", function(){
    it("should return errors when invalid _data.cson file", function(done){
      var root = __dirname + "/fixtures/data-cson/invalid"
      try{
        var poly = polymer.root(root)
      }catch(error){
        should.exist(error)
        error.should.have.property('source', "CSON Data")
        error.should.have.property('dest', "Globals")
        error.should.have.property('lineno')
        error.should.have.property('filename')
        error.should.have.property('message')
...
describe("data-hjson", function(){

  describe("valid", function(){
    var root = __dirname + "/fixtures/data-hjson/valid"
    var poly = polymer.root(root)
  ...
  describe("invalid", function(){
    it("should return errors when invalid _data.hjson file", function(done){
      var root = __dirname + "/fixtures/data-hjson/invalid"
      try{
        var poly = polymer.root(root)
      }catch(error){
        should.exist(error)
        error.should.have.property('source', "HJSON Data")
        error.should.have.property('dest', "Globals")
        error.should.have.property('lineno')
        error.should.have.property('filename')
        error.should.have.property('message')
