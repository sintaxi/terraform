...
describe("javascripts", function(){
  ...
  describe(".cjs", function(){
    var root = __dirname + "/fixtures/javascripts/cjs"
    var poly = polymer.root(root)
    ...
    it("should return errors if invalid javascript", function(done){
      poly.render("invalid.cjs", function(errors, body){
        should.exist(errors)
        should.not.exist(body)
        errors.should.have.property("name")
        errors.should.have.property("message")
  ...
  //       should.not.exist(errors)
  //       body.should.containEql("MODULE_NOT_FOUND")
  //       done()
  //     })
  //   })
  ...
  //       should.not.exist(errors)
  //       body.should.not.containEql("MODULE_NOT_FOUND")
  //       done()
  //     })
  //   })
