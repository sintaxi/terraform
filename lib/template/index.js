...
var scope = module.exports = function(projectPath, partentLocals){
  ...
  return {
    ...
    partial: function(relPath, partialLocals){
      ...
      var renderTemplate  = processors[ext].compile(fileContents.toString(), { filename: filePath })
      var parseError      = processors[ext].parseError

      try{
        return layout
          ? scope(projectPath, locals).partial(layout, { yield: renderTemplate(locals) })
