        ...
        if(!locals.hasOwnProperty('layout')){
          ...
          if(templateLocals && templateLocals.hasOwnProperty('layout')){
            if(templateLocals['layout'] !== true){
              ...
              var relativeLayoutPriorityList = helpers.buildPriorityList(path.join(dirname, templateLocals['layout']))
              var firstLayout = helpers.findFirstFile(root, relativeLayoutPriorityList)

              locals['layout'] = firstLayout
            }
          }
