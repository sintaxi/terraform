...
exports.buildPriorityList = function(filePath){
  ...
  //   list.push(filePath.replace(/.css$/, ".less"))
  //   list.push([filePath, "less"].join("."))
  // }else{
  //   // html
  //   if(path.extname(filePath) == ".html"){
  //     list.push(filePath.replace(/.html$/, ".jade"))
  //   }
  //   list.push([filePath, "jade"].join("."))
  // }
